          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-6 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href="mailto:DrDuffySellls@BravadoHomes.com" className="bg-white border-2 border-blue-600 text-blue-600 px-6 py-2 rounded-lg font-bold hover:bg-blue-50 transition-colors">
